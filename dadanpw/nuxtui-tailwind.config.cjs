      ...
      const { customSafelistExtractor, generateSafelist } = require("D:/Projects/ppdb-app/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "D:/Projects/ppdb-app/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "D:/Projects/ppdb-app/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
