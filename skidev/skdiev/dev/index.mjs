...
import { collections } from 'file://D:/Projects/ppdb-app/skidev/skdiev/nuxt-icon-server-bundle.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/Projects/ppdb-app/skidev/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\ppdb-app\\skidev","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\ppdb-app\\skidev\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\ppdb-app\\skidev\\skdiev","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\ppdb-app\\skidev\\skdiev\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Projects\\ppdb-app\\skidev\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "D:/Projects/ppdb-app/skidev";
...
const getClientManifest = () => import('file://D:/Projects/ppdb-app/skidev/skdiev/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Projects/ppdb-app/skidev/skdiev/dist/server/server.mjs').then((r) => r.default || r);
